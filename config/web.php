...
$config = [
    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                'u/<username:\w+>/p/<page:\d+>'             => 'user/profile/show',
                'u/<username:\w+>/posts/p/<page:\d+>'       => 'user/profile/show',
                'u/<username:\w+>/votados/p/<page:\d+>'     => 'user/profile/votados',
                'u/<username:\w+>/comentarios/p/<page:\d+>' => 'user/profile/comentarios',
                ...
                'u/<username:\w+>/siguiendo'                => 'user/profile/siguiendo',
                'u/<username:\w+>/seguidores'               => 'user/profile/seguidores',
                ...
                'posts/p/<page:\d+>'                        => 'posts/index',
                'posts/search/p/<page:\d+>'                 => 'posts/search',
