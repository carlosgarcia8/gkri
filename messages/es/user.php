...
return [
    ...
    'Update user profile' => 'Actualizar el perfil del usuario',
    ...
    'You have successfully cancelled email changing process' => 'Has cancelado satisfactoriamente la cancelación de proceso de cambio de email',
    ...
    'Networks' => 'Redes',
    'Password' => 'Contraseña',
    'We have generated a password for you' => 'Le hemos generado una contraseña pero recuerde cambiarla una vez haya iniciado sesión por motivos de seguridad, la contraseña es',
    ...
    'Profile' => 'Perfil',
    'Your password on {0} has been changed' => 'Su contraseña en {0} ha cambiado',
    'Your account on {0} has a new password' => 'Su cuenta en {0} tiene una nueva contraseña',
    ...
    'Your account has been created and a message with further instructions has been sent to your email' => 'Tu cuenta ha sido creada y se te ha enviado un correo con unas instrucciones a seguir',
    'Once you delete your account, there is no going back' => 'Una vez que hayas eliminado la cuenta, ya no hay vuelta atrás',
    'Please be certain' => '',
