            ...
            this.settings = e.extend(!0, {}, {
                ...
                createTextBox: function(t, a, n) {
                    ...
                    return l.append(e('<input type="text" class="mg-textbox-text" placeholder="' + t + '" data-text="' + n.text + '" value="' + n.text + '">')), l.append(e('<input type="number" class="mg-textbox-size" value="' + n.fontSize + '" step="' + i.settings.fontSizeStep + '" min="' + i.settings.minFontSize + '" max="' + i.settings.maxFontSize + '">')), i.userSettings.forceUppercase && l.find(".mg-textbox-text").css("textTransform", "uppercase"), 0 != i.settings.colorPicker && (l.append('<input type="text" class="mg-textbox-text-color colorpicker" value="' + n.color + '">'), l.append('<input type="text" class="mg-textbox-border-color colorpicker" value="' + n.borderColor + '">'), l.find(".colorpicker").wrap('<div class="colorpickerContainer"></div>'), i.ui._bindColorpicker(l.find(".colorpicker"))), l.append(e('<input type="number" class="mg-textbox-border-width" value="' + n.borderWidth + '" step="' + i.settings.borderWidthStep + '" min="' + i.settings.minBorderWidth + '" max="' + i.settings.maxBorderWidth + '">')), i.canvasLayers.push(r), l.find(".mg-textbox-text, .mg-textbox-size, .mg-textbox-border-width").on("change keyup", function() {
                        i.userSettings.forceUppercase && e(this).attr("data-text", i.ui._strtoupper(e(this).val())), i.events.onLayerChange(r)
                ...
                resizeHelpers: function() {
                    i.helpersContainer.find("> div").each(function() {
                        var t, a, n, r = i.wrapper.find("[data-layer='" + e(this).attr("data-target-layer") + "']"),
                            s = null;
                        if (r.attr("data-width") && (t = parseInt(r.attr("data-width"), 10) * i.scale, t > i.helpersContainer.width() && (t = i.helpersContainer.width()), e(this).css("width", t), r.attr("data-width", parseInt(t * (1 / i.scale), 10))), r.attr("data-height") && (a = parseInt(r.attr("data-height"), 10) * i.scale, e(this).css("height", a), e(this).resizable("option", "minHeight", a), e(this).resizable("option", "maxHeight", a)), r.attr("data-x") && r.attr("data-y") && (n = r.attr("data-x") * i.scale, n > i.helpersContainer.width() && (n = i.helpersContainer.width() - t), n < 0 && (n = 0), s = r.attr("data-y") * i.scale, s > i.helpersContainer.height() && (s = i.helpersContainer.height() - a), s < 0 && (s = 0), e(this).css({
                                left: n,
                                top: s
                ...
                bootstrapify: function() {
                    ...
                    i.wrapper.hasClass("usingBootstrap") || t.wrapInner('<div class="container-fluid"></div>'), i.wrapper.addClass("usingBootstrap"), t.find(".mg-textbox").each(function() {
                        e(this).hasClass("row") || (e(this).addClass("row"), e(this).find(".mg-textbox-text").addClass("form-control").wrap(e("<div></div>").addClass("col-md-12")), e(this).find(".mg-textbox-size").addClass("form-control").wrap(e("<div></div>").addClass("col-md-3")), e(this).find(".mg-textbox-border-width").addClass("form-control").wrap(e("<div></div>").addClass("col-md-2 template-oculto")), e(this).find(".colorpicker").addClass("form-control"), e(this).find(".colorpickerContainer").addClass("col-md-2 template-oculto"), e(this).find(".colorpickerReplacer").addClass("btn btn-default"))
                    }), t.find(".mg-add-textbox").hasClass("btn") || t.find(".mg-add-textbox").addClass("btn btn-default btn-block").wrap(e("<div></div>").addClass("row template-oculto")), t.find(".mg-advanced-settings-toggle").hasClass("btn") || (t.find(".mg-advanced-settings-toggle, .mg-toolbox-toggle").addClass("btn btn-primary btn-block").wrap(e("<div></div>").addClass("row template-oculto")), t.find(".mg-advanced-settings, .mg-toolbox").addClass("row template-oculto"), t.find(".mg-advanced-settings .option input").wrap('<div class="col-md-1"></div>'), t.find(".mg-advanced-settings .option label").wrap('<div class="col-md-11"></div>')), t.find(".mg-drawing-toggle").hasClass("btn") || (t.find(".mg-drawing-toggle, .mg-drawing-erase").addClass("btn btn-default btn-block"), t.find(".mg-toolbox-item").addClass("col-md-3"))
                },
                ...
                drawText: function(t, a, n, r, s, o, d, l, c, g, p, h) {
                    ...
                    return m.forEach(function(e, t) {
                        u.fillText(e, v, w - p + (o - s) / 2 + t * o), u.strokeText(e, v, w - p + (o - s) / 2 + t * o)
